---
title: "34. Railsアプリケーションの国際化(i18n)対応"
description: "グローバルなサービス展開を目指す上で、アプリケーションを多言語に対応させることは不可欠です。このプロセスは 国際化 (Internationalization)、略して i18n と呼ばれます（Iとnの間に18文字あるため）。"
---
