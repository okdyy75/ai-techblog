---
title: "33. Action Mailer実践ガイド: メール送信とプレビュー、テスト"
description: "ユーザー登録の完了通知、パスワードリセット、通知メールなど、多くのWebアプリケーションにとってメール送信は不可欠な機能です。Railsでは、Action Mailer というフレームワークが用意されており、メールの作成、送信、テストを簡単に行うことができます。"
---
