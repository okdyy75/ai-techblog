---
title: "27. Rails APIモード + Next.jsで構築するモダンなWebアプリケーション"
description: "近年、フロントエンドとバックエンドを分離した開発スタイルが主流になりつつあります。バックエンドはAPIを提供することに専念し、フロントエンドはリッチなユーザーインターフェースを構築します。"
---
