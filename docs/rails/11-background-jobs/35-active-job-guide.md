---
title: "35. Active Job詳解: アダプターの選び方と高度な使い方"
description: "Webアプリケーションでは、メール送信、重いデータの集計、外部APIとの連携など、完了までに時間のかかる処理が発生します。これらの処理をリクエスト/レスポンスサイクル内で同期的に実行すると、ユーザーを長時間待たせてしまい、UXを著しく低下させます。"
---
