---
title: "Rails 8のインライン実行でJavaScriptとCSSの扱いがどう変わるか"
description: "Rails 8では、JavaScriptとCSSの管理において「インライン実行」という新しいアプローチが導入されました。この機能により、外部ファイルの読み込みを減らし、より高速なページレンダリングを実現できます。"
---
