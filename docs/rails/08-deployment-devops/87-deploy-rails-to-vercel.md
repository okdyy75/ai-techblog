---
title: "VercelでRailsアプリケーションをデプロイする2025年版ガイド"
description: "Vercelは、Next.jsを開発したチームが提供するフロントエンド特化型のクラウドプラットフォームとして広く知られていますが、実はRailsアプリケーションのホスティングにも対応しています。"
