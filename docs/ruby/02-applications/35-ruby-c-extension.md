---
title: "RubyとC言語連携（拡張ライブラリ作成）"
description: "Rubyは柔軟で生産性の高い言語ですが、パフォーマンスが要求される計算集約的な処理には向いていない場合があります。そのようなとき、C言語で書かれた高速な処理をRubyから呼び出す「拡張ライブラリ」を作成するのが有効な解決策です。"
---
