---
title: "デコレータとメタデータ（Decorators and Metadata）"
description: "デコレータは、クラスやそのメンバー（メソッド、プロパティなど）を宣言的に修飾するための特別な種類の宣言です。@expression という構文を使用し、expression は修飾対象の情報を引数として受け取る関数でなければなりません。"
---
